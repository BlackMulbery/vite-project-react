    ...
    <div className="relative isolate overflow-hidden bg-white py-24 sm:py-32 dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl dark:text-white">Work with us</h2>
        ...
        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            <div className="flex flex-col-reverse gap-1">
              <dt className="text-base/7 text-gray-700 dark:text-gray-300">Offices worldwide</dt>
              <dd className="text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">12</dd>
            </div>
            <div className="flex flex-col-reverse gap-1">
              <dt className="text-base/7 text-gray-700 dark:text-gray-300">Full-time colleagues</dt>
              <dd className="text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">300+</dd>
            </div>
            <div className="flex flex-col-reverse gap-1">
              <dt className="text-base/7 text-gray-700 dark:text-gray-300">Hours per week</dt>
              <dd className="text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">40</dd>
            </div>
            <div className="flex flex-col-reverse gap-1">
              <dt className="text-base/7 text-gray-700 dark:text-gray-300">Paid time off</dt>
              <dd className="text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">Unlimited</dd>
            </div>
          </dl>
        </div>
      </div>
